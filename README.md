...
<details open>
<summary><b>Kronos</b>: unificação de plataformas de agendamento · <code>Next.js</code> <code>TypeScript</code></summary>
<br>

A Kronos reúne num só lugar as plataformas de agendamento de reuniões, para que quem usa mais de uma não precise lidar com a incompatibilidade entre elas.

Sou co-founder e desenvolvi todo o front-end do produto. Também participei da construção da API REST.

O maior desafio técnico foi a incompatibilidade entre o método de validação que adotamos e as bibliotecas que o projeto já usava. <!-- TODO: diga qual validação, quais bibliotecas e como vocês resolveram -->
</details>

<details>
<summary><b>UsantoosFps</b>: site para um serviço de otimização de PC para jogos · <code>Freelance</code> <code>Vercel</code></summary>
<br>

Site comercial de um cliente que vende otimização de PC e celular para jogos. Fiz o projeto sozinho, do design à implementação do front-end, e publiquei na Vercel. O site está no ar e o cliente já usa.

🔗 <!-- TODO: https://SEU-LINK.vercel.app -->
</details>

<details>
<summary><b>Spring Auth</b>: autenticação com Spring Boot e Next.js · <code>Java</code> <code>Spring Boot</code> <code>Next.js</code></summary>
<br>

Fluxo de autenticação dividido em dois repositórios: uma API em Spring Boot e um front-end em Next.js. Uso este projeto para aprofundar Java e o desenvolvimento de APIs REST.

🔗 [Front-end](https://github.com/EduMoridev/spring-auth-api) · [API em Java](https://github.com/EduMoridev/spring-auth-api.Java)
</details>
...
Aplicação que recebe os dados informados pelo usuário e calcula o resultado em tempo real, sem depender de servidor. Com ela aprendi a tratar entradas do usuário e a escrever a lógica de cálculo do zero.
